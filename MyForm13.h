...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label12->Location = System::Drawing::Point(29, 628);
			this->label12->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label12->Name = L"label12";
			this->label12->Size = System::Drawing::Size(146, 29);
			this->label12->TabIndex = 57;
			this->label12->Text = L"Status   Paid";
			// 
			// label11
			// 
			...
			this->label11->Location = System::Drawing::Point(29, 249);
			...
			this->label10->Location = System::Drawing::Point(29, 523);
			...
			this->label8->Location = System::Drawing::Point(29, 576);
			...
			this->label7->Location = System::Drawing::Point(29, 474);
			...
			this->label6->Location = System::Drawing::Point(29, 430);
			...
			this->label4->Location = System::Drawing::Point(29, 371);
			...
			this->label3->Location = System::Drawing::Point(29, 195);
			...
			this->button2->Location = System::Drawing::Point(222, 704);
			...
			this->ClientSize = System::Drawing::Size(594, 762);
...
#pragma endregion
	private: System::Void MyForm13_Load(System::Object^ sender, System::EventArgs^ e) {
		label1->Text = label1->Text + ": " + Ref;
		label2->Text = label2->Text + ": " + NAM;
		label3->Text = label3->Text + ": " + ADDR;
		label11->Text = label11->Text + ": " + Sie.ToString();
		label5->Text = label5->Text + ": " + Cni;
		label6->Text = label6->Text + ": " + Connect;
		label7->Text = label7->Text + ": " + cons.ToString();
		label8->Text = label8->Text + ": " + tot.ToString();
		label9->Text = label9->Text + ": " + Pay.ToLongDateString();
		label10->Text = label10->Text + ": " + Issue.ToShortDateString();
		label4->Text = label4->Text + ": " + numb;
	}
