...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MyForm21::typeid));
			...
			this->label2->Location = System::Drawing::Point(488, 66);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(335, 39);
			...
			this->button1->Location = System::Drawing::Point(76, 501);
			...
			this->button2->Location = System::Drawing::Point(212, 501);
			...
			this->button2->Click += gcnew System::EventHandler(this, &MyForm21::button2_Click);
			// 
			// textBox3
			// 
			...
			this->textBox3->Location = System::Drawing::Point(39, 309);
			...
			this->textBox4->Location = System::Drawing::Point(41, 411);
			...
			this->label4->Location = System::Drawing::Point(33, 362);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(220, 39);
			this->label4->TabIndex = 61;
			this->label4->Text = L"Reference-ID";
			// 
			// MyForm21
			// 
			...
			this->ClientSize = System::Drawing::Size(1364, 850);
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		if (MessageBox::Show("Send Request?", "Confirm", MessageBoxButtons::YesNo, MessageBoxIcon::Question) == System::Windows::Forms::DialogResult::Yes)
		{
			try {
				...
				sqlconn->Open();
				String^ SqlQuery = "INSERT INTO [Remove] (Name, ReferenceID) VALUES (@Namee, @Addd)";
				SqlCommand^ command = gcnew SqlCommand(SqlQuery, sqlconn);
				command->Parameters->AddWithValue("@Namee", name);
				command->Parameters->AddWithValue("@Addd", ref);
				if (command->ExecuteNonQuery())
					MessageBox::Show("Request Sent Successfully", "Confirm", MessageBoxButtons::OK, MessageBoxIcon::Information);

			}
			catch (SqlException^ ex)
			{
				MessageBox::Show("Request Has been received Already", "Confirm", MessageBoxButtons::OK, MessageBoxIcon::Information);
			}
		}
	}
